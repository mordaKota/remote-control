...
export const setMousePosition = (ws: any) => {
...
export const moveMouseUp = (ws: any, offset: any) => {
	const mouseCoord = robot.getMousePos();
...
export const moveMouseDown = (ws: any, offset: any) => {
	const mouseCoord = robot.getMousePos();
...
export const moveMouseLeft = (ws: any, offset:any) => {
	const mouseCoord = robot.getMousePos();
...
export const moveMouseRight = (ws: any, offset: any) => {
	const mouseCoord = robot.getMousePos();
